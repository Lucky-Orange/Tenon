...
- (void)loadSettings
{
    ...
    // make config.xml in Tenon
    // JohnLui 2015-08-07 17:12:50
    NSString* path = [[NSBundle bundleWithIdentifier:@"com.leqicheng.Tenon"] pathForResource:@"config" ofType:@"xml"];
