...
//    NSBundle* mainBundle = [NSBundle mainBundle];
    ...
    // load index.html in Tenon/www
    // JohnLui 2015-08-07 17:12:50
    NSBundle* TenonBundle = [NSBundle bundleWithIdentifier:@"com.leqicheng.Tenon"];
    ...
    return [TenonBundle pathForResource:filename ofType:@"" inDirectory:directoryStr];
}
