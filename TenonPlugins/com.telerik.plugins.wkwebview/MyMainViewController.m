...
#import <Tenon/CDVTimer.h>
#import <Tenon/CDVLocalStorage.h>
#import <Tenon/CDVUserAgentUtil.h>
#import <Tenon/CDVWebViewDelegate.h>
#import <Tenon/CDVViewController.h>
#import <Tenon/CDVURLProtocol.h>
...
- (WKWebView*)newCordovaWKWebViewWithFrame:(CGRect)bounds wkWebViewConfig:(WKWebViewConfiguration*) config
{
  ...
  _webViewUIDelegate = [[CDVWebViewUIDelegate alloc] initWithTitle:[[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleDisplayName"]];
    _webViewUIDelegate.rootController = self;
...
{
    // load cordova.js before load appUrl
    // JohnLui 2015-08-24 16:20:52
    NSError* error = nil;
    NSString* cordovaJSPath = [[NSBundle bundleWithIdentifier:@"com.leqicheng.Tenon"] pathForResource:@"tenon" ofType:@"js" inDirectory:@"www"];
    NSString* js = [NSString stringWithContentsOfFile:cordovaJSPath encoding:NSUTF8StringEncoding error:&error];
    [self.webView stringByEvaluatingJavaScriptFromString:js];
    if (error != nil) {
        NSLog(@"Failed evaluate cordova.js");
    }
